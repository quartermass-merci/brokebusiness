...
export const ROLES = [
  ...
  },
  {
    ...
    tickets: [
      ...
      t('THE MACRO LIBRARY CONTRADICTS ITSELF', '{n} macros citing three different refund policies', 280),
...
export const DRAFT_POOL = [
  {
    ...
    rule: 'Intercepts CEO fires: bad numbers, stalled launches, Dave.',
  ...
  },
  {
    ...
    rule: 'Intercepts finance fires: rogue refunds and runaway spend.',
  ...
  },
  {
    ...
    capability: 'Agentforce Service Agent: resolves routine cases start to finish.',
  },
  {
    key: 'campaign', kind: 'flagship', role: 'cmo', icon: '📣',
    name: 'CAMPAIGN GUARDRAIL AGENT', short: 'CAMPAIGN AGENT', custom: true,
    rule: 'Intercepts marketing fires: wrong lists, junk leads, the fax machine.',
  ...
  },
  {
    ...
    rule: 'Intercepts sales fires: vibe forecasts and six-hour CRM days.',
  ...
  },
  {
    ...
    rule: 'Intercepts service fires: four-hour queues and duplicate cases.',
  ...
  },
  {
    ...
    capability: 'Agentforce guardrails and grounding, with every action logged.',
  },
  {
